"""
Django settings for mamiux project.
...
SECRET_KEY = '#@t@at(j(jdq*elzh-y5l)x2b^he0r$5y5_st=p#)%4x*yzj#o'
...
WSGI_APPLICATION = 'mamiux.wsgi.application'
